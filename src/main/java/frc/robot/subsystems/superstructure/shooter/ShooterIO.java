...
public interface ShooterIO {
    ...
    default void toVelocity(final double leftFlywheelVelocity, final double rightFlywheelVelocity) {}

    default void setCharacterizationVolts(final double leftVolts, final double rightVolts) {}
