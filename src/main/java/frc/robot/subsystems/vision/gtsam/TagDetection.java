...
public class TagDetection {
    ...
    public static class TagDetectionStruct implements Struct<TagDetection> {
        @Override
        ...
        @Override
        public TagDetection unpack(final ByteBuffer bb) {
        ...
        @Override
        public void pack(final ByteBuffer bb, final TagDetection value) {
            bb.putInt(value.id);
            for (int i = 0; i < 4; i++) {
